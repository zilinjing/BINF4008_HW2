...
def load_transformers_model(args: argparse.Namespace):
    ...
    """
    TODO(student-extract-1): Load tokenizer/model for label extraction.
    Hint:
    ...
    """
    # START TODO(student-extract-1)

    # END TODO(student-extract-1)
...
def batch_extract(
    ...
    """
    TODO(student-extract-2): Run batched generation and decode CheXpert labels.
    Hint:
    ...
    """
    # START TODO(student-extract-2)

    # END TODO(student-extract-2)
    extracted = []
